...
const uri =
  "mongodb+srv://EcoTrack-1:ER2KlnVSjsdlgond@cluster0.iwft1b3.mongodb.net/ecotrack?retryWrites=true&w=majority";
...
const sampleEvents = [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1559028006-848e64271f8e?w=600",
    isVirtual: true,
...
async function addEventsToMongoDB() {
  ...
  try {
    ...
    console.log(`Existing events count: ${existingCount}`);

    if (existingCount < 4) {
      // Insert remaining sample events
