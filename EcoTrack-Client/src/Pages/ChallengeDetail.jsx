            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative h-64">
                <img
                  src={
                    challenge.imageUrl ||
                    getPlaceholderImage(challenge.category, challenge.title)
                  }
                  alt={challenge.title}
                        ...
                        <li key={index} className="flex items-start space-x-2">
                          <div className="flex-shrink-0 w-6 h-6 bg-emerald-100 rounded-full flex items-center justify-center">
                            ...
                            >
                              <path
                                fillRule="evenodd"
                                d="M16.707 5.293a1 1 0 010-1.414 1.414l-4-4a1 1 0 00-1.414-1.414L4.586 3H3a1 1 0 00-.707-.293l.293-.293a1 1 0 011.414 1.414l4 4a1 1 0 001.414 1.414l-.293.293a1 1 0 01-1.414 1.414L15.414 17H17a1 1 0 00.707.293l-.293.293a1 1 0 00-1.414-1.414L4.586 13H3z"
                                clipRule="evenodd"
                              />
                            </svg>
                          </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-yellow-600">
                          {challenge.rewards?.badge || "No badge"}
                        </p>
                      </div>
                      <div className="text-right">
                        ...
                        <p className="text-sm text-yellow-600">
                          {challenge.rewards?.certificate ? "Available" : "N/A"}
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full flex items-center justify-center space-x-2 bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md transition-colors">
                    Copy Link
                  </button>
                </div>
              </div>
